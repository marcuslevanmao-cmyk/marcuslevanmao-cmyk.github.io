...
// ============================================================
// 1. CONTENT DEFINITIONS — now using the REAL full content from editor.js
// ============================================================

// ---- Full Essay (copied from editor.js tab_1) ----
...
// ---- Full Brainstorm (copied from editor.js tab_2) ----
...
// ============================================================
// 2. FULL HISTORY — all 8 Marcus edits with the real content
// ============================================================
...
// Use the hardcoded history, but if there's a stored version with more entries, use that
let currentHistory = loadHistoryFromStorage() || documentHistory.slice();
// Ensure we always have at least the initial 8 entries
if (currentHistory.length < documentHistory.length) {
    currentHistory = documentHistory.slice();
}
